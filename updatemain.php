...
<body>
    ...
    <!-- Login Form -->
    <form action="updatemainprocess.php" method="post" enctype="multipart/form-data">
        <p>
            <label>NAME:</label>
        ...
        <p>
            ...
            <input type="text" id="wabi" name="wabi" />
        </p>

        <p>
            <label>Maintance BILL:</label>
            <input type="text" id="mabi" name="mabi" />
        </p>
        <p>
            <label>DATE:</label>
